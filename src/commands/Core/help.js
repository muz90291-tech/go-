...
export async function createInitialHelpMenu(client) {
    ...
    const embed = createEmbed({
        ...
        description: 'A clean command center for moderation, security, community tools, tickets, giveaways, and server utilities.',
        color: 'primary',
        ...
        fields: [
            {
                ...
                value: [
                    ...
                    '**2. Configure modules** — Use `/commands dashboard` to manage available systems.',                    '**3. Browse commands** — Use the menu below to view categories and commands.',
                ].join('\n'),
                inline: false,
            },
            {
    ...
    embed.setFooter({ 
        text: "KyraBot • Built for Discord communities" 
    });
    embed.setTimestamp();
